...
class Cochera:
    ...
    def ingresar_vehiculo(self):
        ...
        if self.lugares[ubicacion] is False: # Si la ubicacion esta libre...
            ...
            registro=",".join([self.lugares[ubicacion]["ingreso"].strftime("%d-%m-%Y-%H-%M"), ubicacion,self.lugares[ubicacion]["vehiculo"].dominio, self.lugares[ubicacion]["vehiculo"].tipo])+"\n"
            # print(registro)
